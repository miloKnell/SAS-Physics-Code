...
def optimal_launch_deg(r_orgin,e,a):
    ...
    window = 180 - (360/p_o)*p_h #degrees ahead of orgin for optimal launch window
    return window

dv1,dv2 = circular_circular(r_earth,r_jupiter) #Earth to Jupiter
dv1,dv2 = circular_eliptical(r_earth,e,a) #Earth to Pluto
launch = optimal_launch_deg(r_earth,e,a) #degrees ahead of Earth for optimal launch window to Pluto
